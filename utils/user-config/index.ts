...
import { fetchPageTool, searchOnlineTool, viewImageTool, viewPdfTool, viewTabTool } from '../llm/tools/prompt-based/tools'
...
${new PromptBasedToolBuilder(viewTabTool)}

${new PromptBasedToolBuilder(viewPdfTool)}

${new PromptBasedToolBuilder(viewImageTool)}

${new PromptBasedToolBuilder(searchOnlineTool)}

${new PromptBasedToolBuilder(fetchPageTool)}
